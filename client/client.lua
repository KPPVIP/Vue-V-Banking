...
Citizen.CreateThread(function()
	while true do
		...
		if isInMarker and not hasAlreadyEnteredMarker then
			...
			TriggerEvent('ali_bank:hasEnteredMarker', currentZone)
		end

		if not isInMarker and hasAlreadyEnteredMarker then
			hasAlreadyEnteredMarker = false
			TriggerEvent('ali_bank:hasExitedMarker', lastZone)
		end
	end
end)

AddEventHandler('ali_bank:hasEnteredMarker', function(zone)
